...
class NewsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.slider2.layoutManager = LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false)
        binding.slider2.adapter = ProductAdapter(Globals.shared.StoredDataProducts)

        binding.slider3.layoutManager = LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false)
        binding.slider3.adapter = CategoryAdapter(Globals.shared.StoredDataCategory)

        binding.slider4.layoutManager = LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false)
        ...
        binding.slider4.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                binding.editorsChoiceField.setColorFilter(R.color.gray_filter, PorterDuff.Mode.SCREEN)
            }
        })
